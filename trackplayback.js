            ...
            const a = n.a.Class.extend({
                    ...
                    _getCalculateTrackPointByTime: function (t) {
                        ...
                        if (_time_ !== u.time) {
                            ...
                            if (nextTab) {
                                nextTab = false;
                                app.curTab = app.curTab + 1;
                                tool.displayTab(app.curTab);
                            }
                            if (curLine) {
                            ...
                            // if (bg) {
                            //     timeLine.style.backgroundColor = '#bbdaef';
                            // } else {
                            //     timeLine.style.backgroundColor = '#bbdaef00';
                            // }
                            // bg = !bg;
                            // if (u.speed > 0) {
                            //     timeLine.innerHTML = `
                            //     <span>${tool.getDate(u.time)} |</span> <span style="color: #0c7516">${u.lat} - ${
                            //         u.lng
                            //     }</span>
                            // `;
                            // } else {
                            //     timeLine.innerHTML = `
                            //     <span>${tool.getDate(u.time)} |</span> <span style="color: #c0231c">${u.lat} - ${
                            //         u.lng
                            //     }</span>
                            // `;
                            // }
                            // if (document.querySelectorAll('.time-line').length >= 19) {
                            //     document.querySelector('.coordinates-table').firstChild.remove();
                            // }
                            // document.querySelector('.coordinates-table').appendChild(timeLine);
                        }
...
throw new Error('img load error!');
                    ...
                    _drawTrack: function (t) {
                        ...
                        this.targetOptions.useImg && this._targetImg ? this._drawShipImage(i) : this._drawShipCanvas(i),
                            this.targetOptions.showText && this._drawtxt(`èˆªå‘ï¼š${parseInt(i.dir)}åº¦`, i),
